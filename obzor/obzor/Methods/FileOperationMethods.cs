...
namespace obzor.Methods
{
    internal class FileOperationMethods
    {
        ...
        {
            variables.originalDataTable = ((DataTable)dataGridView1.DataSource).Copy();
        }
        ...
        {
            if (variables.originalDataTable != null && !variables.originalDataTable.Equals((DataTable)dataGridView1.DataSource))
            {
